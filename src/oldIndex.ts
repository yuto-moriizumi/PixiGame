...
window.onload = () => {
  ...
  app.loader
    .add("examples/assets/eggHead.png", "./brazil.png")
    .add("examples/assets/flowerTop.png", "./brazil.png")
    .add("examples/assets/helmlok.png", "./brazil.png")
    .add("examples/assets/skully.png", "./brazil.png")
    .load(onAssetsLoaded);
